# AIp12b.py: AI practices - 12 > program b: a proctor/guesser of AB game
# Jia-Sheng Heh, 10/20/2019, revised from AIp11dd.py
...
def index():
    ...
    return "<html><body>" + openF + "<p><input type='text' name='dd' size='6' background-color='888888'/></p>" + "<button type='submit'>送出</button>" + "</body></html>"
